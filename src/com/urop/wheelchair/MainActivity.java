...
public class MainActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mDataList = (Button) findViewById(R.id.button1); //links the login button to a variable
		...
		mDataList.setOnClickListener(new View.OnClickListener() { // listens for a button press

			@Override
			public void onClick(View v) {
				
					Intent intent = new Intent(MainActivity.this, DataActivity.class); //the screen switches from the main activity to the login screen
